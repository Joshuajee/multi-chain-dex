...
import MDexV1NativeFactoryABI from "@/abi/contracts/MDexV1PairNative.sol/MDexV1PairNative.json";
import { convertToEther, supportedNetworks } from '@/libs/utils'
import LoadingButton from '@/components/utils/LoadingButton'
import { CHAIN_ID, DOMAIN_ID, GAS_FEES } from '@/libs/enums'
...
export default function NewPosition() {
    ...
    const gasQuotes = useContractRead({
        ...
        args: [pair2Details.domainId, GAS_FEES.MUMBAI],
        chainId: pair1Details.chainId,
        enabled: tokenSelected(pair1Details.chainId, pair2Details.chainId)
    })
    ...
    const createPair = useContractWrite({
        ...
        args: [pair2Details.domainId, GAS_FEES.MUMBAI, pair2Details.factoryAddress, { value: gasQuotes.data }],
        chainId: pair1Details.chainId,
    })
