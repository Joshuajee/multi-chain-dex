...
interface IMDexV1NativeFactory is INonfungibleNativeLiquidity {
    ...
    function swapReceiver(uint32 _remoteDomain, uint _amountIn, uint256 _amountOut, address _to) external;
    ...
    function removeLiquidityReceiver(bytes32 _id, uint32 _remoteDomain, address _owner) external;
